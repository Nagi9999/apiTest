...
const Member = () => {
  ...
  return (
    <div className="  justify-center pt-20 my-20">
    <div className="flex flex-wrap justify-between sm:space-x-16 space-x-4 sm:space-y-16 space-y-4 my-8">
      {Data.map((item) => {
        return (
          <div
            key={item.id}
            className="w-[25%] flex-col px-8 sm:px-8 py-4 sm:py-8 rounded-md text-justify text-white text-2xl max-w-[300px]"
          >
